...
class MockTest(TestCase):
    ...
    def test_objectview(self):
        ...
        swiftclient.client.get_container = mock.Mock(return_value=(meta, objects))
    ...
    def test_download(self):
        ...
        resp = self.client.get(reverse('download', kwargs={
                                        ...
                                        'objectname': 'testfile'})) 
        self.assertEqual(resp.status_code, 302)
        self.assertEqual(resp['Location'], 'http://testserver/objects/container/')
    ...
    def test_public_objectview(self):
        ...
        meta = {}
        objects = [{'name': 'testfile'}, {'subdir': 'pre'}, {'name': 'pre/fix'}]
        swiftclient.client.get_container = mock.Mock(return_value=(meta, objects))
